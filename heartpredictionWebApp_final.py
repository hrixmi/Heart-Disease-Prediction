...
loaded_model=pickle.load(open('/Users/hrishikeshmishra/Downloads/PROJECT/trained_model.sav','rb'))
...
def main():
    ...
    image = Image.open("/Users/hrishikeshmishra/Downloads/pngegg.png")
    with col2:
    ...
    st.markdown('[View source code](https://github.com/your_username/your_repository)', unsafe_allow_html=True)
